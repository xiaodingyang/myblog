  ...
  >
    ...
    >
      <div className="relative z-10 max-w-6xl mx-auto px-4 md:px-6 flex flex-col lg:flex-row items-center gap-4 md:gap-8 lg:gap-16 w-full">
        ...
        <div className="flex-1 text-center lg:text-left space-y-6">
          ...
          {/* Title line 1 */}
          <S w="85%" h="52px" r="rounded-lg" dark />
          {/* Title line 2 */}
          <S w="65%" h="52px" r="rounded-lg" dark />
          {/* Subtitle */}
      ...
      <div className="home-fullscreen-section-inner w-full flex flex-col py-6 md:py-8">
        <div className="max-w-6xl mx-auto px-4 md:px-6 w-full">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 md:gap-6">
            {/* Big card */}
            <div className="lg:col-span-7 relative overflow-hidden rounded-2xl md:rounded-3xl min-h-[280px] md:min-h-[400px] skeleton-shimmer-dark p-6 flex flex-col justify-end">
              <S w="60px" h="24px" r="rounded-full" dark />
              <S w="75%" h="28px" r="rounded-lg" dark className="mt-3" />
            ...
            <div className="lg:col-span-5 flex flex-col gap-4 md:gap-6">
              {[1, 2].map(i => (
                <div key={i} className="relative overflow-hidden rounded-2xl h-[180px] md:h-[190px] skeleton-shimmer-dark p-5 flex flex-col justify-end">
                  <S w="50px" h="20px" r="rounded-full" dark />
                  <S w="80%" h="22px" r="rounded-lg" dark className="mt-2" />
    ...
    >
      <div className="relative z-10 max-w-4xl mx-auto px-4 md:px-6 text-center bg-black/50 backdrop-blur-sm rounded-2xl md:rounded-3xl p-6 md:p-12 shadow-2xl">
        ...
        <S w="256px" h="40px" r="rounded-lg" dark className="mx-auto mb-4" />
