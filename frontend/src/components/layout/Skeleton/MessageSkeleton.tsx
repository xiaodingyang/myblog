    ...
    <div className="animate-fade-in py-8">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="text-center mb-12">
          <div className="w-16 h-16 rounded-2xl bg-white/10 animate-pulse mx-auto mb-4" />
          <div className="h-10 w-32 rounded-lg bg-white/10 animate-pulse mx-auto mb-3" />
          ...
          >
            ...
            <div className="flex gap-3">
              ...
              <div className="flex-1 space-y-3">
                <div className="h-24 rounded-lg bg-white/6 animate-pulse" />
